...
## IGNORE: Upgrading Go Version

**- Pattern:** Upgrading the Go version in `go.mod` and `mise.toml` to a newer version (e.g., 1.25.7).
**- Justification:** The project strictly uses Go 1.24.7 to maintain environment consistency. Modifying this version causes pipeline mismatches and is rejected.
